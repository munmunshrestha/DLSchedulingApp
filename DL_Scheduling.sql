...
ALTER TABLE LEAVE_REQUEST DROP FOREIGN KEY fk9;
...
CREATE TABLE LEAVE_REQUEST (
    ...
    LR_START_TIME int NOT NULL,
    LR_END_TIME int NOT NULL,
...
-- Reference: fk3 (table: SP_LEAVE_REQUEST)
ALTER TABLE LEAVE_REQUEST ADD CONSTRAINT fk8 FOREIGN KEY fk8 (LR_START_TIME)
    REFERENCES TIME (ID);
    
    -- Reference: fk3 (table: SP_LEAVE_REQUEST)
ALTER TABLE LEAVE_REQUEST ADD CONSTRAINT fk9 FOREIGN KEY fk9 (LR_END_TIME)
    REFERENCES TIME (ID);
-- End of file.
