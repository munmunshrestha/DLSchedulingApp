...
DROP TABLE IF EXISTS SP_DLCLASSES, SP_LEAVE_REQUEST, SP_STUDENT_UNAVAILABILITY, SP_USER,SP_USERs;
...
CREATE TABLE SP_STUDENT_UNAVAILABILITY (
    ...
    STD_START_TIME varchar(19) NOT NULL,
    STD_END_TIME varchar(10) NOT NULL,
